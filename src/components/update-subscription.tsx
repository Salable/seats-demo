...
import {SubscriptionExpandedPlanCurrency} from "@/fetch/subscriptions";
import LoadingSpinner from "@/components/loading-spinner";
import {addSeats, removeSeats} from "@/app/actions/subscriptions";

export const UpdateSubscription = ({seatCount, subscription}: {seatCount: number, subscription: SubscriptionExpandedPlanCurrency}) => {
