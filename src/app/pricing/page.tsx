  ...
  if (!session?.uuid) {
    return (
      <Link
        ...
        className='block p-4 text-white rounded-md leading-none bg-blue-700 hover:bg-blue-800 transition w-full text-center'
      >
        Sign up
      </Link>
    )
    ...
    <>
      {check?.data?.capabilities?.find((a) => a.capability === 'basic') ? (
        ...
        <Link href='/src/app/dashboard/subscriptions'
              className='block p-4 text-white rounded-md leading-none bg-blue-700 hover:bg-blue-800 transition w-full text-center'>Move to Basic plan</Link>
      ) : (
