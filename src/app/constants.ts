...
if (!process.env.NEXT_PUBLIC_SALABLE_PLAN_UUID)
  throw new Error("Missing env NEXT_PUBLIC_SALABLE_PLAN_UUID");
if (!process.env.NEXT_PUBLIC_SALABLE_PRO_PLAN_UUID)
  throw new Error("Missing env NEXT_PUBLIC_SALABLE_PRO_PLAN_UUID");
if (!process.env.NEXT_PUBLIC_SALABLE_API_BASE_URL)
  throw new Error("Missing env NEXT_PUBLIC_SALABLE_API_BASE_URL");
if (!process.env.NEXT_PUBLIC_SALABLE_PRO_PLAN_UUID)
  throw new Error("Missing env NEXT_PUBLIC_SALABLE_PRO_PLAN_UUID");
if (!process.env.NEXT_PUBLIC_PRODUCT_UUID)
  throw new Error("Missing env NEXT_PUBLIC_PRODUCT_UUID");
if (!process.env.NEXT_PUBLIC_APP_BASE_URL)
  throw new Error("Missing env NEXT_PUBLIC_APP_BASE_URL");
